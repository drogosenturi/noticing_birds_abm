...
to setup-patches ;; procedure to assign plant species to each patch and identify neighbors
  ...
  ask patches
  [
    set patch-richness round random-exponential mean-richness ;; assigns patch richness randomly to yards
    if patch-richness > 16 [ set patch-richness round random-exponential mean-richness ]
