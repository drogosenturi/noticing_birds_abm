...
[
  ...
  block-veg-volume ;; average veg volume of yards in block
...
to setup-blocks
  ...
  ask patches
  [
    set block-veg-volume sum [ vegetation-volume ] of block-mates
  ]
end
...
to move-birds
  ask birds [
    ...
    if roll < 0.5
    [ move-to one-of patches with [ vegetation-volume > 1 ] ]
  ]
end
